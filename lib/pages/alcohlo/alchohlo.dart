...
class Alcohol extends StatefulWidget {
  ...
  @override
  State<Alcohol> createState() => _InviteState();
}

class _InviteState extends State<Alcohol> {
  int a = 1;
              ...
              Stack(
                children: [
                  ...
                  Align(
                    child: Divider(
                      height: 3,
                      endIndent: MediaQuery.of(context).size.width * 0.28,
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                      width: 1,
                      color: a == 4 ? Color(0xFF76A9FF) : Color(0xFF1C1C1C),
                    ),
                  ),
                  fixedSize: Size(double.maxFinite, 50),
                  backgroundColor: Color(0xFF1C1C1C),
